...
Logistics (verified from Delta/Marriott emails):
- Airline: Delta, conf GH6BOL — out DL1953 MCO 10:45 AM → LGA 1:26 PM
  (Jul 30); home DL2520 LGA 3:39 PM → MCO 6:54 PM (Aug 2). Delta Comfort+.
- Hotel: Residence Inn New York Downtown Manhattan/World Trade Center
  Area, 170 Broadway — conf #91549485, corner King Studio (booked Jul 28
  after two earlier reservations were rebooked/cancelled: #91517806,
  #68482194, #69502951). Check-in 4 PM, checkout noon.
- Perk: the hotel sent $10/day Lyft ride credits ("Residence Inn World
  Trade Center Pass") — Aug 2 email.
- Ground: rideshare LGA ↔ hotel; subway + walking everywhere in the city
  ("great"); twin nieces rented bikes in Central Park; double-decker
  hop-on/hop-off bus through the city; boat ride to the Statue of
  Liberty (the kids loved it).

## Hotel report (Elizabeth, 2026-07-08)
- Breakfast excellent — lots of hot & cold food, no need to eat anywhere
  else (same pattern as CA Residence Inn: breakfast quality pays).
- Guest laundry available.
- Corner King Studio with a great view — "definitely want that again"
  → PERMANENT PLAY: request corner/high-floor room with view.
- Whole Foods at One Wall Street (66 Broadway) two blocks away — used
  several times.

## Getting around
Walk: yes — very walkable. Subway + walking was the winning combo;
rideshare only for airport runs. Bikes: Central Park rental was a
highlight. Safety: great everywhere EXCEPT Chinatown after dark (felt a
little sketchy — daylight only); twin nieces loved Times Square at night.

## Morning run (Elizabeth)
~4 miles every morning: the Two Bridges loop — Brooklyn Bridge +
Manhattan Bridge (verified: the classic loop is ~4 mi; Manhattan Bridge
confirmed as "the other bridge right there," landing at Chinatown) —
straight from the hotel door.
...
- Chinatown/Canal St: fine by day, sketchy at night — split from Little
  Italy in the journal so the warning is visible.

## Stop list (25 items, Elizabeth) → 24 journal stops
The Edge · Roosevelt Island Tramway · Grand Central · Rockefeller ·
Radio City (×2 visits) · Times Square & Theater District · St.
Patrick's · Central Park & bikes · double-decker bus · Chelsea Market ·
High Line · Chelsea Gallery District · Chelsea Piers ("girls") · Little
Italy · Chinatown & Canal St · Trump Tower/5th Ave · Wall St (NYSE &
Fed) · Oculus · Brookfield Place & Winter Garden · Statue of Liberty ·
