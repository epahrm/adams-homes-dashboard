...
export default function CredentialsSection({ emailLogin, lassoLogin, fpgTrainingUrl }: Props) {
    ...
    <div className="card p-6 mb-6 border-l-4 border-secondary">
      ...
      <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
        <p className="text-xs text-blue-900">
          <strong>💡 Tip:</strong> Save these credentials securely. Contact your division manager if you need help.
        </p>
      </div>
    </div>
  )
